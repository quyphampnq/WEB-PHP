...
<table class="table">
  ...
  foreach($products as $product){?>
    <tr>
      ...
      <td><a href='<?php echo BASE_URL?>adminproduct/productDelete/<?php echo $product["productid"]?>' onclick='return confirm("Ban Co Chac Chan Xoa Vinh Vien SP Nay ?")'>Xóa Vĩnh Viễn</a>|<a href='<?php echo BASE_URL?>adminproduct/productToggleTrash/<?php echo $product['productid']?>'>Khôi Phục</a></td>
    </tr>
    <?php }?>
  </tbody>
</table>
